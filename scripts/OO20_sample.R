...
data_dir <- 'C:/Users/Administrator/Desktop/seurat analysis/OO20_sample_filtered_feature_bc_matrix'
...
# seurat_object <- CreateSeuratObject(counts = data, project = "OO20_sample", min.cells = 3, min.features = 200)
...
seurat_object <- CreateSeuratObject(counts = data[["Gene Expression"]], project = "OO20_sample", min.cells = 3, min.features = 200)
...
#save_path <- "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample.rds"  

# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample.rds")
...
# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample_02_with_filter_percent.mt.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample_02_with_filter_percent.mt.rds")
...
png("C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/plot_OO20_sample_variable_feature_2000.png", width = 1000, height = 800)
plot1 + plot2
dev.off()
...
png("C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/heatmap_OO20_sample_pca_1_to_15.png", width = 1600, height = 1600, res=150)
DimHeatmap(seurat_object, dims = 1:15, cells = 500, balanced = TRUE)
dev.off() 
...
# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample_03_with_filter_percent.mt.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO20_sample/seurat_object_OO20_sample_03_with_filter_percent.mt.rds")
...
VlnPlot(seurat_object, features = c("PPBP", "S100A9"))

# plot raw counts as well
VlnPlot(seurat_object, features = c("PPBP", "S100A9"), layer = "counts", log = TRUE)

## visualizes feature expression on a umap 
FeaturePlot(seurat_object, features = c("PPBP", "S100A9", "S100A8", "IGLC3", "PF4", "GNG11", "LYZ", "GP1BB","BANK1","AL136456.1"))
...
FeaturePlot(seurat_object, features = c("TSHZ2", "LTB", "KLRF1", "IFI30", "GZMH", "CD79A", "LRMDA"))
