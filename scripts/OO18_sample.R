...
data_dir <- 'C:/Users/Administrator/Desktop/seurat analysis/OO18_sample_filtered_feature_bc_matrix'
...
# seurat_object <- CreateSeuratObject(counts = data, project = "OO18_sample", min.cells = 3, min.features = 200)
...
seurat_object <- CreateSeuratObject(counts = data[["Gene Expression"]], project = "OO18_sample", min.cells = 3, min.features = 200)
...
#save_path <- "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample.rds"  

# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample.rds")
...
# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample_02_with_filter_percent.mt.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample_02_with_filter_percent.mt.rds")
...
png("C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/plot_OO18_sample_variable_feature_2000.png", width = 1000, height = 800)
plot1 + plot2
dev.off()
...
png("C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/heatmap_OO18_sample_pca_1_to_15.png", width = 1600, height = 1600, res=150)
DimHeatmap(seurat_object, dims = 1:15, cells = 500, balanced = TRUE)
dev.off() 
...
# Save the Seurat object
saveRDS(seurat_object, file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample_03_with_filter_percent.mt.rds")

# Load the saved Seurat object
seurat_object <- readRDS(file = "C:/Users/Administrator/Desktop/seurat analysis/OO18_sample/seurat_object_OO18_sample_03_with_filter_percent.mt.rds")
...
VlnPlot(seurat_object, features = c("INPP4B", "FOLR3"))

# plot raw counts as well
VlnPlot(seurat_object, features = c("INPP4B", "FOLR3"), layer = "counts", log = TRUE)

## visualizes feature expression on a umap 
FeaturePlot(seurat_object, features = c("INPP4B", "FOLR3", "EEF1A1", "RPS3A", "NELL2", "GZMH", "PAX5", "KLRF1","CCL5","C1QA","TMEM40"))
